    ...
    if method in {"ppo", "grpo"}:
        return DeepRLConfig(
            **common,
            ...
            advantage_mode=str(payload.get("advantage_mode", defaults["advantage_mode"])),
            gae_lambda=_float_payload(payload, "gae_lambda", float(defaults["gae_lambda"]), minimum=0.0, maximum=1.0),
